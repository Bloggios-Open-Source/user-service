 ...
 * Owner - Rohit Parihar
 * Author - rohit
 * Project - auth-provider-write-api
 * Package - com.bloggios.auth.provider.write.utils
...
public class AsyncUtils {
    ...
    private static RuntimeException handleException(Throwable cause) {
        ...
        } else if (cause instanceof AuthenticationConfigException authenticationException) {
